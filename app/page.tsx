...
export default function HomePage() {
  return (
    <main className="relative min-h-[100dvh] overflow-hidden bg-neutral-950 text-white sm:min-h-screen">
      ...
      <section className="mx-auto flex min-h-[100dvh] w-full max-w-3xl items-center justify-center px-4 py-3 sm:min-h-screen sm:px-6 sm:py-12 lg:px-8">
